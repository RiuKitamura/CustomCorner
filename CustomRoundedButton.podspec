Pod::Spec.new do |spec|
  ...
  spec.author             = { "Habib Akbar" => "akbarhabib460@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/RiuKitamura/CustomCorner.git", :tag => "#{spec.version}" }
